          ...
          >
            ...
            <h4 className="text-sm font-semibold text-gray-900 leading-snug mb-0.5 group-hover:text-blue-600 transition-colors flex items-center gap-1">
              ...
              {deal.hasWabaConversation && (
                <span
                  className="inline-flex items-center justify-center w-[18px] h-[18px] rounded-full bg-emerald-100 flex-shrink-0"
                  title="Conversa WhatsApp Oficial (WABA)"
                >
                  <svg width="11" height="11" viewBox="0 0 24 24" fill="currentColor" className="text-emerald-600">
              ...
              {!deal.hasWabaConversation && deal.hasWhatsAppConversation && (
                <span
                  className="inline-flex items-center justify-center w-[16px] h-[16px] rounded-full bg-gray-100 flex-shrink-0"
