...
const FIELDS: Record<string, FieldMeta> = {
  ...
  gender:               { label: "Gênero", type: "enum", category: "Contato",
                          enumOptions: [{ value: "MASCULINO", label: "Masculino" }, { value: "FEMININO", label: "Feminino" }] },
  erpSystem:            { label: "Sistema usado (ERP)", type: "text", category: "Contato" },
  revenueRange:         { label: "Faixa de faturamento", type: "enum", category: "Contato",
                          enumOptions: [
