...
const FIELDS: Record<string, FieldMeta> = {
  ...
  dealStageName:        { label: "Etapa do funil", type: "text", category: "Funil" },
  dealValue:            { label: "Valor da negociação", type: "number", category: "Funil" },
  dealSourceId:         { label: "Fonte do lead", type: "id", category: "Funil" },
  dealLostReasonId:     { label: "Motivo de perda", type: "id", category: "Funil" },
  dealProductName:      { label: "Produto contratado", type: "text", category: "Funil" },
  dealUserId:           { label: "Responsável (vendedor)", type: "id", category: "Funil" },
  dealCampaignId:       { label: "Campanha da negociação", type: "id", category: "Funil" },
